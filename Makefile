...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fri Jun 10 19:26:02 2011
# Project:  cfd3.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/local/cuda/lib64 -L/home/az/NVIDIA_GPU_Computing_SDK/C/common/obj/x86_64/release -L/usr/lib -L/usr/X11R6/lib -lnoise -lcudart -lGLEW -lQtSvg -lQtOpenGL -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cfd31.0.0/ && $(COPY_FILE) --parents kernels.cu .tmp/cfd31.0.0/ && $(COPY_FILE) --parents RenderWidget.h cfd3.h .tmp/cfd31.0.0/ && $(COPY_FILE) --parents main.cpp RenderWidget.cpp cfd3.cpp .tmp/cfd31.0.0/ && $(COPY_FILE) --parents cfd3.ui .tmp/cfd31.0.0/ && (cd `dirname .tmp/cfd31.0.0` && $(TAR) cfd31.0.0.tar cfd31.0.0 && $(COMPRESS) cfd31.0.0.tar) && $(MOVE) `dirname .tmp/cfd31.0.0`/cfd31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cfd31.0.0
