...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fri Jun 3 18:56:18 2011
# Project:  cfd3.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4/QtSvg -I/usr/include/qt4 -I/usr/local/cuda/include -I/usr/X11R6/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/local/cuda/lib64 -L/usr/lib -L/usr/X11R6/lib -lcudart -lQtSvg -lQtOpenGL -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		moc_cfd3.cpp
OBJECTS       = ${OBJECTS_DIR}test_cuda.obj \
		main.o \
		RenderWidget.o \
		cfd3.o \
		moc_RenderWidget.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cfd31.0.0/ && $(COPY_FILE) --parents test.cu .tmp/cfd31.0.0/ && $(COPY_FILE) --parents RenderWidget.h cfd3.h .tmp/cfd31.0.0/ && $(COPY_FILE) --parents main.cpp RenderWidget.cpp cfd3.cpp .tmp/cfd31.0.0/ && $(COPY_FILE) --parents cfd3.ui .tmp/cfd31.0.0/ && (cd `dirname .tmp/cfd31.0.0` && $(TAR) cfd31.0.0.tar cfd31.0.0 && $(COMPRESS) cfd31.0.0.tar) && $(MOVE) `dirname .tmp/cfd31.0.0`/cfd31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cfd31.0.0
...
compiler_cuda_make_all: ${OBJECTS_DIR}test_cuda.obj
compiler_cuda_clean:
	-$(DEL_FILE) ${OBJECTS_DIR}test_cuda.obj
${OBJECTS_DIR}test_cuda.obj: test.cu
	nvcc -c -Xcompiler -pipe -I "/usr/local/cuda/include" test.cu -o ${OBJECTS_DIR}test_cuda.obj
